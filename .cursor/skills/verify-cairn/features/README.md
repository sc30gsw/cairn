...
- [Plan](./plan.md) covers `/plan`: DatePicker plus Clock on `プラン`, timed 予定 on `スケジュール`, and the absence of Clock on the schedule tab.
