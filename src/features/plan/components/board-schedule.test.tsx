...
import type { PlanExternalEvent } from "~/features/plan/types/plan";
...
const external: PlanExternalEvent = {
  _id: "external-holiday" as PlanExternalEvent["_id"],
  allDay: true,
  calendarId: "holidays",
  calendarName: "日本の祝日",
...
function planView(level: "week" | "month" | "year"): PlanViewState {
  return {
    ...derivePlanView({ date: "2026-09-23", view: level }, "2026-09-30"),
    today: "2026-09-30",
...
function renderSchedule(level: "week" | "month" | "year") {
  return renderWithMantine(
    <BoardSchedule blocks={[]} externals={[external]} items={[]} view={planView(level)} />,
  );
}
