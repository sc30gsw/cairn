...
import type { useBoardScheduleActions } from "~/features/plan/hooks/use-board-schedule-actions";
import type { useBoardScheduleUi } from "~/features/plan/hooks/use-board-schedule-ui";
import {
...
export function useBoardScheduleInteractions({
  ...
  function saveEventRange(
    ...
    void actions.onMoveBlock({ endAt, event: editableEvent.value, startAt });
  }
