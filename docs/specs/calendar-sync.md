...
| Google に出す予定の形（Q17） | 予定: 題名 = 予定の title、説明 = 項目名とひとこと（あれば）、色は priority の Banana / Sage / Blueberry（5 / 2 / 9）、予定あり。項目なしも送る。本番日: 「本番: 〈内容〉」終日・空き、説明に目標スコア。期限: 「期限: 〈内容〉」終日・空き、説明に親目標 |
